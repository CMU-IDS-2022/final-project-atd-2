...
Looking at this analysis, the government can take necessary measures to plan out their investments and strategies for the upcoming years in order to ensure that the country's energy requirements are met. From a climate change perspective, this also helps a country understand that their energy needs are growing and there can possibly be plans in place to generate electricity using clean methods like water, air and solar energy. The second visualization on fossil fuels and renewable energy, directly helps countries directly monitor their electricity generation using fossil fuels and renewable energy. Using all these analyses, the country can also plan actions to reduce energy consumption.

One example of how this analysis can be used, wherein an actionable insight can be derived from the energy based analysis is listed below:

Suppose Greece wants to plan their energy wise investments for the next 10 years,  they can look at the following outputs generated by our application:

![](img/Picture19.png)

![](img/Picture20.png)

As can be seen in the Electricity demand vs Generation regression graph, it is clear that the electricity demand is increasing at a faster rate than the electricity generation.  This clearly means that the Greek government needs to look at possible ways of generating more electricity.  

Moreover, as can be seen from the Fossil-fuel electricity share vs Renewable electricity share graph, the energy generated from the renewable energy sources are increasing and are estimated to increase in the coming years. Similarly, the energy generated using fossil fuels has been decreasing over the years.  From a climate change perspective, this is a good indication for the country that they are reducing fossil fuel burning by increasing the use of renewable energy for electricity generation. But, from a demand vs supply perspective, it is clearly not enough and the Greek government need to possibly take measures to meet the forecasted energy demand for the country.
